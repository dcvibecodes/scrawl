        ...
        <div class="settings-container">
            ...
            <div class="settings-section">
                ...
                <div style="position:relative; margin-top:14px;">
                    <div id="customPagesAdd" style="display:flex;column-gap:8px;row-gap:15px;align-items:center;flex-wrap:wrap;">
                    ...
                    <span class="settings-status" id="customPagesStatus" style="position:absolute; left:0; top:100%; margin-top:6px; margin-left:0; white-space:nowrap; pointer-events:none;"></span>
                </div>
            </div>
